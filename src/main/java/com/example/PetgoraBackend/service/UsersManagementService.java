...
public class UsersManagementService {
    ...
    public ReqRes updateUser(Integer userId, OurUsers updatedUser) {
        ...
        try {
            ...
            if (userOptional.isPresent()) {
                ...
                existingOurUsers.setEmail(updatedUser.getEmail());
                existingOurUsers.setName(updatedUser.getName());
                existingOurUsers.setCity(updatedUser.getCity());
                existingOurUsers.setRole(updatedUser.getRole());

                // Check if password is present in the request
                if (updatedUser.getPassword() != null && !updatedUser.getPassword().isEmpty()) {
                    // Encode the password and update it
                    existingOurUsers.setPassword(passwordEncoder.encode(updatedUser.getPassword()));
                }
    ...
    public ReqRes updateUserProfile(String email, OurUsers updatedUser) {
        ReqRes reqRes = new ReqRes();
        try {
